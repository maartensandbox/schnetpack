...
def build_prob_mlp(
    ...
    prior_mean=bayesian_params["prior_mu"]
    prior_variance=bayesian_params["prior_sigma"]
    posterior_mu_init=bayesian_params["posterior_mu_init"]
    posterior_rho_init=bayesian_params["posterior_rho_init"]
